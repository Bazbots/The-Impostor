...
client = commands.Bot(
    command_prefix=["$", "<@759436027529265172>", "<@759436027529265172> "], description="An Among Us bot for Discord!", case_insensitive=True)
...
status = cycle(["Among Us on Discord! | $help, $info",
