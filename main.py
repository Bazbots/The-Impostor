...
async def on_guild_join(guild):
  ...
  console = discord.Embed(
    title="Console",
    description=f"I have joined {guild}"
  )
...
async def on_guild_remove(guild):
  ...
  console = discord.Embed(
    title="Console",
    description=f"I have left {guild}"
  )
  await channel.send(embed=console)
...
status = ["Among Us on Discord! | $help, $info", "https://www.patreon.com/theimpostor | $patreon","https://bazbots.github.io/The-Impostor | $info", f"Version {__version__} | $version","Vote for the bot by running $vote {site} | $info","The GitHub Repository | $info", "What do you think? | $feedback","$help, $info","Use the prefix $ or @The Impostor", "Created by Baz!"]
